...
export const normalUserNavItems: NavItem[] = [
  {
  ...
  },
  {
    displayName: 'Account Setting',
    iconName: 'user-circle',
    route: 'dashboard/account-setting',
  },
  {
  ...
  {
    displayName: 'General Tag Request',
    iconName: 'mail',
    route: 'tag-request-form',
  },
];

export const guestUserNavItems: NavItem[] = [
  {
    displayName: 'Register',
    iconName: 'user-plus',
    route: '/authentication/side-register'
