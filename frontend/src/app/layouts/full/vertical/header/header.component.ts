...
export class HeaderComponent {
  ...
  logout(): void {
    this._userautherizeService.logout();
  }
  ...
  changeLanguage(lang: any): void {
    ...
    this.setLanguageInLocalStorage(lang.code);
  }

  public setLanguageInLocalStorage(languageCode: string): void {
  ...
  getLanguageFromLocalStorage(): void {
    ...
    if (languageCode) {
      this.selectedLanguage = this.languages.find(lang => lang.code === languageCode);
    } else {
...
export class AppSearchDialogComponent {
  ...
  //   const userState = this._userautherizeService.getUserState();
  //   switch (userState) {
  //     case 0:
